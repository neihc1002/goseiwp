...
class AWSM_Job_Openings {
	...
	public static function get_specifications_content_1( $posted_date) {
		$spec_content = sprintf('<div class="awsm-job-specification-item awsm-job-specification-posted-date"><i class="awsm-job-icon-calendar"></i><span class="awsm-job-specification-term">%1$s</span></div>', $posted_date);
		$spec_content = sprintf( '<div class="awsm-job-specification-wrapper">%1$s</div>', $spec_content );
		return apply_filters( 'awsm_specification_content_1', $spec_content);
	}
