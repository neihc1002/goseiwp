...
final class WordPressReporter {
	...
	public function get_fields() {
		return [
			'version'               => esc_html__( 'Version', 'masker-elementor' ),
			'site_url'              => esc_html__( 'Site URL', 'masker-elementor' ),
			'home_url'              => esc_html__( 'Home URL', 'masker-elementor' ),
			'is_multisite'          => esc_html__( 'WP Multisite', 'masker-elementor' ),
			'max_upload_size'       => esc_html__( 'Max Upload Size', 'masker-elementor' ),
			'memory_limit'          => esc_html__( 'Memory limit', 'masker-elementor' ),
			'permalink_structure'   => esc_html__( 'Permalink Structure', 'masker-elementor' ),
			'language'              => esc_html__( 'Language', 'masker-elementor' ),
			'timezone'              => esc_html__( 'Timezone', 'masker-elementor' ),
			'admin_email'           => esc_html__( 'Admin Email', 'masker-elementor' ),
			'debug_mode'            => esc_html__( 'Debug Mode', 'masker-elementor' ),
		];
	}
	...
	public function get_memory_limit() {
		...
		if ( $memory_limit_bytes < $min_recommended_bytes ) {
			$result['recommendation'] = esc_html__( 'We recommend setting memory to at least 64M. For more information, ask your hosting provider.','masker-elementor' );
	...
	public function get_is_multisite() {
		return [
			'value' => is_multisite() ? esc_html__( 'Yes', 'masker-elementor' ) : esc_html__( 'No', 'masker-elementor' )
		];
	}
	...
	public function get_permalink_structure() {
		...
		if ( ! $structure ) {
			$structure = esc_html__( 'Plain', 'masker-elementor' );
		}
	...
	public function get_debug_mode() {
		return [
			'value' => WP_DEBUG ? esc_html__('Active', 'masker-elementor' ) : esc_html__('Inactive', 'masker-elementor' )
		];
	}
