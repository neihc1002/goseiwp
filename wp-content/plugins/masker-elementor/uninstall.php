...
final class Uninstall {
	...
	private function __construct() {
		...
		Helper::get_instance()->send_action( 'uninstall', 'masker-elementor', '1.0.0' );
	...
	public function get_uninstall_mode() {
		...
		if( isset( $uninstall_settings['mdp_masker_elementor_uninstall_settings'] ) AND $uninstall_settings['mdp_masker_elementor_uninstall_settings'] ) { // Default value.
			$uninstall_settings = [
	...
	public function remove_settings() {
		...
		$settings = [
			'mdp_masker_elementor_envato_id',
			'mdp_masker_elementor_settings',
			'mdp_masker_elementor_uninstall_settings',
